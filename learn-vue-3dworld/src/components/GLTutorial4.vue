...
export default {
  mounted() {
    ...
    const Viewer = require("three/examples/jsm/utils/ShadowMapViewer");
    ...
    var shadowMapViewer = new Viewer.ShadowMapViewer( light );
    ...
    //camera helper
    var newCamera = new THREE.PerspectiveCamera(35,  myCanvas.clientWidth / myCanvas.clientHeight, 300, 1000 );
